import '../views/components/imported_model_projector_setting.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (model.isImported && model.format == OnDeviceModelFormat.gguf)
              ImportedModelProjectorSetting(model: model),
            const SizedBox(height: 8),
